				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php foreach ($project_by_session as $v_project_by_session) { ?>
							<tr>
								<td><a href="{{URL::to('/project_details/'.$v_project_by_session->project_id)}}">{{$v_project_by_session->Project_name}}</a></td>
								<td class="center">{{$v_project_by_session->member1_name}}</td>
								<td class="center">{{$v_project_by_session->member2_name}}</td>
								<td class="center">
									<span class="label label-success">{{$v_project_by_session->teacher_name}}</span>
								</td>
								<td class="center">{{$v_project_by_session->course_name}}</td>
								<td class="center">{{$v_project_by_session->type_name}}</td>
								<!-- <td class="center">
