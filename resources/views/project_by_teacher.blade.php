				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php foreach ($project_by_teacher as $v_project_by_teacher) { ?>
							<tr>
								<td><a href="{{URL::to('/project_details/'.$v_project_by_teacher->project_id)}}">{{$v_project_by_teacher->Project_name}}</a></td>
								<td class="center">{{$v_project_by_teacher->member1_name}}</td>
								<td class="center">{{$v_project_by_teacher->member2_name}}</td>
								<td class="center">
									<span class="label label-success">{{$v_project_by_teacher->course_name}}</span>
								</td>
								<td class="center">{{$v_project_by_teacher->session}}</td>
								<td class="center">{{$v_project_by_teacher->type_name}}</td>
								<!-- <td class="center">
