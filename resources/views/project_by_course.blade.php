				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php foreach ($project_by_course as $v_project_by_course) { ?>
							<tr>
								
								<td><a href="{{URL::to('/project_details/'.$v_project_by_course->project_id)}}">{{$v_project_by_course->Project_name}}</a></td>
								<td class="center">{{$v_project_by_course->member1_name}}</td>
								<td class="center">{{$v_project_by_course->member2_name}}</td>
								<td class="center">
									<span class="label label-success">{{$v_project_by_course->teacher_name}}</span>
								</td>
								<td class="center">{{$v_project_by_course->session}}</td>
								<td class="center">{{$v_project_by_course->type_name}}</td>
								<!-- <td class="center">
